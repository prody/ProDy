...
for key, txt, val in [
    ...
    ('outcflex', 'write continuousflex modes directory and sqlite', False),
...
def addNMAOutput(parser):
    ...
    parser.add_argument('-y', '--export-continuousflex', dest='outcflex', action='store_true',
        default=DEFAULTS['outcflex'], help=HELPTEXT['outcflex'])
