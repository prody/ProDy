...
Let's associate this ensemble with the *structure* we parsed from the PDB 
file::
...
Now, we can get calculate RMSDs and RMSFs as follows:: 
  ...
  print ensemble.getRMSDs().round(2)
  # [ 0.96  1.38  1.86  1.67  1.82  2.    ...  2.23  2.36  2.38  2.42]
  print ensemble.getRMSFs().round(2)
...
In this case, superposition was based on Cα atom coordinates:: 
  ...
  print ensemble.getRMSDs().round(2)
  # [ 0.57  0.66  1.08  0.87  1.01  1.08  ...  1.09  1.28  1.16  1.17]
  print ensemble.getRMSFs().round(2)
  # [ 1.63  1.23  0.8   0.6   0.51  0.46  ...  1.55]
...
*dcd* to return the the 0th frame::
  ...
  # [ 0.96  1.38  1.86  1.67  1.82  2.    ...  2.23  2.36  2.38  2.42]
  print rgyr.round(2)
  # [ 12.95  13.08  12.93  13.03  12.96  ...  13.1   13.15  13.18  13.1 ]
...
Instances of this class are also suitable for previous calculations::
  ...
  for i, frame in enumerate(traj):
      ...
      rmsd[i] = frame.getRMSD()
  print rmsd.round(2)
  # [ 0.96  1.38  1.86  1.67  1.82  2.    ...  2.34  2.3   2.37  2.36]
  print rgyr.round(2)
  # [ 12.95  13.08  12.93  13.03  12.96  ...  12.9   12.94  12.98  12.96]
...
Let's calculate end-to-end distance::
  ...
  for i in range(500):
      ...
      structure.nextFrame()
  print e2e.round(2)
  # [ 11.79  14.13  15.66  14.52  16.46  ...  12.54  11.34  11.55  11.47]
