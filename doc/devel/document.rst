...
ProDy package documentation strings and pages contain examples that can be used
to test ProDy.  Run the following commands after changes in core features
and before new release to make sure new bugs are not introduced::
