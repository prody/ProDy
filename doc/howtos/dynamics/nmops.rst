...
>>> print anm_one[0]
Mode 1 from 1p38_anm
>>> print anm_two[0]
Mode 1 from 1r39_anm
...
>>> print np.outer( np.array(list(anm_one[:3])),  np.array(list(anm_two[:3])) )
...
>>> anm_one[0] * 10
<Vector: 10*(Mode 1 from 1p38_anm)>
...
<Vector: 3*(Mode 1 from 1p38_anm) + Mode 2 from 1p38_anm + 2*(Mode 3 from 1p38_anm)>
...
0.148971269751*(Mode 1 from 1p38_anm) + 0.24904210757*(Mode 2 from 1p38_anm)
...
-5.60860594784*(Mode 1 from 1p38_anm) + 2.15393365959*(Mode 2 from 1p38_anm) + -3.13701609199*(Mode 3 from 1p38_anm)
