...
.. glossary::
   ...
   DCD
     NAMD produces DCD trajectory files in the same format as X-PLOR and
     CHARMM. DCD files are single precision binary FORTRAN files, so are
     transportable between computer architectures. Source:
