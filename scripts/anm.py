...
def main():
    ...
    parser.add_option('-p','--prefix',dest="prefix",type="string",default="anm",metavar="STRING",help="prefix for output files (%default)")
...
"""
    ...
    # gnm calculation
    anm = ANM(os.path.splitext(os.path.split(pdbfn)[1])[0])
