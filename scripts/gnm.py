...
def main():
    ...
    parser.add_option('-p','--prefix',dest="prefix",type="string",default="gnm_",metavar="STRING",help="prefix for output files (%default)")
...
"""
    ...
    # gnm calculation
    gnm = GNM('GNM pdb:%s select:%s cutoff:%0.2f gamma:%0.2f'%(pdb,select,cutoff,gamma))
